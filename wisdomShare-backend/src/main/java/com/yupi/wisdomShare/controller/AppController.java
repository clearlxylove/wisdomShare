...
import com.yupi.wisdomShare.common.*;
...
public class AppController {
    ...
    public BaseResponse<Long> addApp(@RequestBody AppAddRequest appAddRequest, HttpServletRequest request) {
        //请求参数错误
        ThrowUtils.throwIf(appAddRequest == null, ErrorCode.PARAMS_ERROR);//params_error
        // 在此处将实体类和 DTO 进行转换
        App app = new App();
     ...
     */
    @PostMapping("/update")
    @AuthCheck(mustRole = UserConstant.ADMIN_ROLE)//自定义注解，必须是管理员角色
